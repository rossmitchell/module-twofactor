...
namespace Rossmitchell\Twofactor\Tests\Integration\Customer\CustomerCreation;
...
class OptionShouldNotShowWhenDisabledTest extends AbstractTestClass
{
    ...
    public function testUseTwoFactorIsDisplayed()
    {
        ...
        $this->assertNotContains('Use Two Factor Authentication', $body);
    }
}
