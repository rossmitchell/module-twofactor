...
class CanHandleNoUserTest extends AbstractTestClass
{
    ...
    {
        $this->getRequest()->setMethod('POST')->setParam('secret', 'notarealcode');
        $this->dispatch('/backend/twofactor/adminlogin/verify');

        $this->assertRedirect($this->stringContains('admin/index/index'));
    }
}
