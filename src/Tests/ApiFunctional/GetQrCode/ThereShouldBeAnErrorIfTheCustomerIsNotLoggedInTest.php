...
class ThereShouldBeAnErrorIfTheCustomerIsNotLoggedInTest extends GetQrCodeAbstract
{

    public function testNonLoggedInCustomersSeeAnError()
    {
        $result       = $this->makeRequestThatShouldFail(401);
